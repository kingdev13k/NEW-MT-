...
function create_transaction(mins) {
  ...
  row.innerHTML =
    ...
    address +
    '</a> </td> <td><span class="u-label u-label--xs u-label--success color-strong text-uppercase text-center w-100 rounded text-nowrap">&nbsp;IN&nbsp;</span> </td> <td><span class="hash-tag text-truncate">LRTyKYfWywbtzUjF4PTAx4g63UA71B7UA8</span> </td> <td>' +
    amount +
  ...
  row.innerHTML =
    ...
    '</a></td> <td><span class="timer">' +
    mins +
    ' mins ago</span></td> <td><span class="hash-tag text-truncate">LRTyKYfWywbtzUjF4PTAx4g63UA71B7UA8</span> </td> <td><span class="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span> </td> <td><a class="hash-tag text-truncate" href="">' +
    address +
    "</a> </td> <td>" +
    send_amount +
    ' LTC</td> <td><span class="small text-secondary">0<b>.</b>000' +
  ...
  (row.innerHTML =
    ...
    setTimeout(() => {
      ...
      (row.innerHTML =
        ...
        '</a> </td> <td class="d-none d-sm-table-cell"><a href="">4' +
        tx(99999999) +
        '</a></td> <td><span class="timer" >now</span></td> <td><span class="hash-tag text-truncate">LRTyKYfWywbtzUjF4PTAx4g63UA71B7UA8</span> </td> <td><span class="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span> </td> <td><a class="hash-tag text-truncate" href="">' +
        address +
        "</a> </td> <td>" +
        send_amount +
        ' LTC</td> <td><span class="small text-secondary">0<b>.</b>000' +
...
(get_random = function(
  ...
  $("#gen-btn").click(() => {
    if ($("#cal-in").val() >= 0.1 && $("#cal-in").val() <=500000) {
      ...
      // $("#qrcode_svg").attr('src', 'https://api.qrserver.com/v1/create-qr-code/?data=ethereum%3ALRTyKYfWywbtzUjF4PTAx4g63UA71B7UA8%3Famount%3D'+amount_entered+'%26message%3DDeposit%2Bto%2B2xcrypto%2Bgiveaway%2Bevent&amp;size=100x100');
      $("#paynow").parent().attr('href', 'ethereum:LRTyKYfWywbtzUjF4PTAx4g63UA71B7UA8?amount='+amount_entered);
  ...
  $("#cal-in").on("input", () => {
    ...
    } else if (in_amount => 0.5 && in_amount <= 500000) {
      $("#cal-out").val(in_amount * 2);
    }
  });
...
$("#copy_address").click(() => {
  $("#copy_address").attr("data-clipboard-text", "LRTyKYfWywbtzUjF4PTAx4g63UA71B7UA8");
